        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 p-4 p-lg-0">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="process">
                    <li><a class="dropdown-item"
                            href="prestation_allocations.php"><?= $lang['header']['services-allocation']; ?></a>
                    </li>
                    <li>
                        <hr class="dropdown-divider" />
                    </li>
                    <li><a class="dropdown-item"
                            href="prestation_locations_bus.php"><?= $lang['header']['services-bus']; ?></a></li>
                    <li>
                        <hr class="dropdown-divider" />
                    </li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="docu">
                    <li><a class="dropdown-item" href="status.php"><?= $lang['header']['docu-status']; ?></a></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><a class="dropdown-item" href="rules.php"><?= $lang['header']['docu-rules']; ?></a></li>
                </ul>
            </li>
            <!-- Docus End -->
            ...
            <!-- Members Start -->
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="members" role="button" data-bs-toggle="dropdown"
                    aria-expanded="false">
                    <?= $lang['header']['team']; ?>
                </a>
                <ul class="dropdown-menu" aria-labelledby="members">
                    ...
                    <li><a class="dropdown-item" href="team_predecessor.php"><?= $lang['header']['team-before']; ?></a>
                    </li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
            ...
            <li class="nav-item ">
                ...
                <a id="profile" href="profile.php" class="nav-item nav-link "
