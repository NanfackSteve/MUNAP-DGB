                    ...
                    <div class="row g-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 bg-light">
                                <p class="p-4" style="text-align: justify;">L’Assemblée Générale est l’instance suprême
                                    de
                                    la
                                    Mutuelle.
                                    Elle comprend tout le personnel de la Direction Général du Budget.
                                    Les travaux de l’Assemblée Générale sont présidés par le Directeur Général du
                                    Budget.
                                <ul>Elle est chargée :
                        ...
                        <div class="row mt-5 ">
                            <img class="img" src="img/header/team_members.jpg" style="min-height: 30rem;">
                        </div>
                    </div>

                    <div class=" d-grid gap-2 col-6 mx-auto m-4">
                        <a href="team_CA.php" class="btn btn-primary">Voir Conseil d'Administration</a>
                        <a href="team_BE.php" class="btn btn-primary">Voir Bureau Executif</a>
                        <a href="team_CF.php" class="btn btn-primary">Voir Commission Financiere</a>
                        <a href="team_DR.php" class="btn btn-primary">Voir Délégation Régionale</a>
                    </div>
