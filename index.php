                ...
                <div class="col-md-6 col-lg-12 mt-3">
                    ...
                    <p style="text-align: justify;" class="m-2 wow fadeIn" data-wow-delay="0.4s">
                        <?= $lang['index']['president-word-brief'] ?> <a href="#" data-bs-toggle="modal"
                            data-bs-target="#dgb-speech-modal"><?= $lang['index']['read-more'] ?><i
                                class="ms-2 fa fa-arrow-right ms-1"></i></a></p>
                </div>


                <!-- Speech Modal Start -->
                <div class="modal fade" id="dgb-speech-modal" tabindex="-1" aria-labelledby="dgb-speech-modal"
                    aria-hidden="true">
