...
<body>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                ...
                                <a href="about.php#title-1" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Lire
                                    plus</a>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                ...
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">____________</p>
                                <a href="about.php#title-2" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Lire
                                    plus</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                ...
                                <h1 class="display-3 text-white animated slideInDown mb-4">STATUTS DES DISPOSITIONS
                                    FINANCIERES</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">____________</p>
                                <a href="about.php#title-3" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Lire
                                    plus</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid border rounded-3" src="img/dgb/capture13.jpg" alt="" style="height: 250px;">
                        </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid border rounded-3" src="img/dgb/capture4.jpg" alt="" style="height: 250px;">
                        </div>
                        <div class="p-4 text-center border border-5 border-light border-top-0">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid border rounded-3" src="img/dgb/capture14.jpg" alt="" style="height: 250px;">
                        </div>
                        <div class="p-4 text-center border border-5 border-light border-top-0">
                            <h4 class="mb-3">Assemblée Générale Extraodinaire </h4>
                            <p>Renouvellement et installation des nouveaux responsables.</p>
                            <a class="fw-medium" href="">Read More<i class="fa fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-title text-center">
                <h1 class="display-5 mb-5">La Direction</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative">
                            <img class="img-fluid" src="img/organism/DGB.jpg" alt="" style="height: 280px; width: 100%;">
                        ...
                        <div class="text-center border border-5 border-light border-top-0 p-4">
                            <h5 class="mb-0">M. EDOU Alo'o Cyrill</h5>
                            <small>Directeur Général du Budget</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative">
                            <img class="img-fluid" src="img/organism/Directeur_Executif.jpg" alt="" style="height: 280px; width: 100%;">
                            <div class="team-social">
                                <a class="btn btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square" href=""><i class="fab fa-instagram"></i></a>
                        ...
                        <div class="text-center border border-5 border-light border-top-0 px-2 py-4">
                            <h5 class="mb-0">Mme GOMA GOMA Flore</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <div class="overflow-hidden position-relative">
                            <img class="img-fluid" src="img/organism/Tresorier_General.jpg" alt="" style="height: 280px; width: 100%;">
                            <div class="team-social">
                                <a class="btn btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square" href=""><i class="fab fa-instagram"></i></a>
            ...
            <div class="wow fadeInUp text-center mt-4"><a class="fw-medium " href="team.php">Voir Tous les Membres
