            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item">
                            <div class="overflow-hidden">
                                <img class="img-fluid border rounded-3" src="img/dgb/capture13.jpg" alt=""
                                    style="height: 250px;">
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item">
                            <div class="overflow-hidden">
                                <img class="img-fluid border rounded-3" src="img/dgb/capture4.jpg" alt=""
                                    style="height: 250px;">
                            </div>
                            <div class="p-4 text-center border border-5 border-light border-top-0">
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item">
                            <div class="overflow-hidden">
                                <img class="img-fluid border rounded-3" src="img/dgb/capture14.jpg" alt=""
                                    style="height: 250px;">
                            </div>
                            <div class="p-4 text-center border border-5 border-light border-top-0">
                                <h4 class="mb-3">Assemblée Générale Extraodinaire </h4>
                                <p>Renouvellement et installation des nouveaux responsables.</p>
                                <a class="fw-medium" href="news_1.php">Lire plus<i
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="team-item">
                            <div class="overflow-hidden position-relative">
                                <img class="img-fluid" src="img/organism/SG.jpg" alt=""
                                    style="height: 280px; width: 100%;">
                                <div class="team-social">
                                    <a class="btn btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square" href=""><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item">
                            <div class="overflow-hidden position-relative">
                                <img class="img-fluid" src="img/organism/SGA.jpg" alt=""
                                    style="height: 280px; width: 100%;">
                                <div class="team-social">
                                    <a class="btn btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square" href=""><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item">
                            <div class="overflow-hidden position-relative">
                                <img class="img-fluid" src="img/organism/Tresorier_General.jpg" alt=""
                                    style="height: 280px; width: 100%;">
                                <div class="team-social">
                                    <a class="btn btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square" href=""><i class="fab fa-twitter"></i></a>
