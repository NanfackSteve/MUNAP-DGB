                        ...
                        <div class="card  shadow">
                            ...
                            <div class="card-body pt-1 pb-0">
                                <div class="row card-text pb-0">
                                    <ul class="col" style="list-style-type: none; padding-left: 0.5rem; ">
                                        <li><span
                                                class="me-1"><b><?= $lang['Profile']['cost']['fees_parent'] ?></b></span><span
                                                class="mx-2">/
                                            </span><span><?= $cotisation_parent ?></span> FCFA</li>
                                        <li><span
                                                class="me-1"><b><?= $lang['Profile']['cost']['fees_spouse'] ?></b></span><span
                                                class="mx-2">/
                                            </span><span><?= $cotisation_conjoint ?></span> FCFA</li>
                                        <li><span
                                                class="me-1"><b><?= $lang['Profile']['cost']['fees_child'] ?></b></span><span
                                                class="mx-2">/
                                            </span><span><?= $cotisation_enfant ?></span> FCFA</li>
                                        <li><span
                                                class="me-1"><b><?= $lang['Profile']['cost']['fees_member'] ?></b></span><span
                                                class="mx-2">/
                                            </span><span><?= $cotisation_mutualiste ?></span> FCFA</li>
                                        <li><span
                                                class="me-1"><b><?= $lang['Profile']['cost']['fees_total'] ?></b></span><span
                                                class="mx-2">/
