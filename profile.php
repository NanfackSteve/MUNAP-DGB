                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item "><a class="text-white underline-hover"
                                href="index.php"><?= $lang['Profile']['link-home'] ?></a>
                        </li>
                        <li class="breadcrumb-item"><a class="text-white underline-hover" data-bs-toggle="modal"
                                data-bs-target="#pwdModal" href="#"><?= $lang['Profile']['link-pwd'] ?></a>
                        </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div id="modal-body" class="modal-body py-3">
                        <div class="form-floating mb-3">
                            <input type="password" id="new-pass-1" name="new-pass-1" class="form-control"
                                placeholder="">
                            <label for="floatingPass-1"><?= $lang['Profile']['pwd-input-1'] ?></label>
                        </div>

                        <div class="form-floating">
                            <input type="password" id="new-pass-2" name="new-pass-2" class="form-control"
                                placeholder="">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="btn-pwd" class="btn btn-primary"
                            onclick="changePwd('<?= $_SESSION['token'] ?>', '<?= $num_adhesion ?>')"><?= $lang['Profile']['btn-pwd'] ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid bg-white mt-3">
            <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    echo '<tbody>';
                                    echo '    <tr>';
                                    echo '      <td>' . $cotisation['montantacotisermembre'] . '</td>';
                                    echo '      <td>' . $cotisation['montantversemembre'] . '</td>';
                                    echo '    </tr>';
                                    echo '</tbody>';
                                    echo '</table>';
                                    ?>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="btn btn-primary" data-bs-target="#conjointModal"
                                        data-bs-toggle="modal"
                                        data-bs-dismiss="modal"><?= $lang['Profile']['modal-affiliate']['see-1'] ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="btn btn-primary" data-bs-target="#childModal" data-bs-toggle="modal"
                                        data-bs-dismiss="modal"><?= $lang['Profile']['modal-affiliate']['see-2'] ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="btn btn-primary" data-bs-target="#parentModal" data-bs-toggle="modal"
                                        data-bs-dismiss="modal"><?= $lang['Profile']['modal-affiliate']['see-3'] ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row my-0 card-text pb-0">
                                    <ul class="col mt-2 mb-2" style="list-style-type: none; padding-left: 0.5rem; ">
                                        <li id="birth"
                                            ...
                                            <span id="alloc-birth"
                                                class="badge rounded-pill bg-primary ms-4"><?= $nbr_allocation_naissance ?></span>
                                            <a href="#" class="btn btn-primary btn-sm bo" data-bs-toggle="modal"
                                                data-bs-target="#birthModal"><i
                                                    class="fa fa-eye me-1"></i><?= $lang['Profile']['see-more'] ?>
                                            </a>
                                        </li>
                                        <li id="wedding"
                                            ...
                                            <span id="alloc-wedding"
                                                class="badge rounded-pill bg-primary"><?= $nbr_allocation_mariage ?></span>
                                            <a href="#" class="btn btn-primary btn-sm bo" data-bs-toggle="modal"
                                                data-bs-target="#weddingModal"><i
                                                    class="fa fa-eye me-1"></i><?= $lang['Profile']['see-more'] ?>
                                            </a>
                                        </li>
                                        <li id="hospital"
                                            ...
                                            <span id="alloc-hospital"
                                                class="badge rounded-pill bg-primary ms-4"><?= $nbr_allocation_medicaux ?></span>
                                            <a href="#" class="btn btn-primary btn-sm bo" data-bs-toggle="modal"
                                                data-bs-target="#hospitalModal"><i
                                                    class="fa fa-eye me-1"></i><?= $lang['Profile']['see-more'] ?>
                                            </a>
                                        </li>
                                        <li id="medal"
                                            ...
                                            <span id="alloc-medal"
                                                class="badge rounded-pill bg-primary ms-4"><?= $nbr_allocation_decoration ?></span>
                                            <a href="#" class="btn btn-primary btn-sm bo" data-bs-toggle="modal"
                                                data-bs-target="#medalModal"><i
                                                    class="fa fa-eye me-1"></i><?= $lang['Profile']['see-more'] ?>
                                            </a>
                                        </li>
                                        <li id="retirement"
                                            ...
                                            <span id="alloc-retirement"
                                                class="badge rounded-pill bg-primary ms-4"><?= $nbr_allocation_retraite ?></span>
                                            <a href="#" class="btn btn-primary btn-sm bo" data-bs-toggle="modal"
                                                data-bs-target="#retirementModal"><i
                                                    class="fa fa-eye me-1"></i><?= $lang['Profile']['see-more'] ?>
                                            </a>
                                        </li>
                                    </ul>
                    ...
                    <div class="modal fade" id="birthModal" tabindex="-1" aria-labelledby="birthModal"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    ...
                                    if (empty($list_allocation_naissance)) {
                                        echo $lang['Profile']['modal-allocation']['no-child'];
                                    } else {
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal"><?= $lang['Profile']['close'] ?></button>
                                    <button class="btn btn-primary" data-bs-target="#weddingModal"
                                        data-bs-toggle="modal"
                                        data-bs-dismiss="modal"><?= $lang['Profile']['modal-allocation']['see-2'] ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="weddingModal" tabindex="-1" aria-labelledby="weddingModal"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal"><?= $lang['Profile']['close'] ?></button>
                                    <button class="btn btn-primary" data-bs-target="#hospitalModal"
                                        data-bs-toggle="modal"
                                        data-bs-dismiss="modal"><?= $lang['Profile']['modal-allocation']['see-4'] ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="hospitalModal" tabindex="-1" aria-labelledby="hospitalModal"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal"><?= $lang['Profile']['close'] ?></button>
                                    <button class="btn btn-primary" data-bs-target="#medalModal" data-bs-toggle="modal"
                                        data-bs-dismiss="modal"><?= $lang['Profile']['modal-allocation']['see-3'] ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="medalModal" tabindex="-1" aria-labelledby="medalModal"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal"><?= $lang['Profile']['close'] ?></button>
                                    <button class="btn btn-primary" data-bs-target="#retirementModal"
                                        data-bs-toggle="modal"
                                        data-bs-dismiss="modal"><?= $lang['Profile']['modal-allocation']['see-5'] ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="retirementModal" tabindex="-1" aria-labelledby="retirementModal"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal"><?= $lang['Profile']['close'] ?></button>
                                    <button class="btn btn-primary" data-bs-target="#birthModal" data-bs-toggle="modal"
                                        data-bs-dismiss="modal"><?= $lang['Profile']['modal-allocation']['see-1'] ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
