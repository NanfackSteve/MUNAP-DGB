                                ...
                                <div class="row card-text pb-0">
                                    <ul class="col mt-2 mb-2" style="list-style-type: none; padding-left: 0.5rem; ">
                                        <li id="parent"
                                            ...
                                            Parent(s)
                                            <span id="parent-number" class="badge rounded-pill bg-primary ms-4">1</span>
                                            <a href="#" class="btn btn-primary btn-sm bo" data-bs-toggle="modal"
                                                data-bs-target="#parentModal"><i class="fa fa-eye me-1"></i>Voir
                                            </a>
                                        </li>
                                        <li id="conjoint"
                                            class="list-group-item d-flex justify-content-between align-items-center map">
                                            Conjoint(es)
                                            <span id="conjoint-number" class="badge rounded-pill bg-primary">1</span>
                                            <a href="#" class="btn btn-primary btn-sm bo" data-bs-toggle="modal"
                                                data-bs-target="#conjointModal"><i class="fa fa-eye me-1"></i>Voir
                                            </a>
                                        </li>
                                        <li id="child"
                                            class="list-group-item d-flex justify-content-between align-items-center map">
                                            ...
                                            <a href="#" class="btn btn-primary btn-sm bo" data-bs-toggle="modal"
                                                data-bs-target="#childModal"><i class="fa fa-eye me-1"></i>Voir
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="btn btn-primary" data-bs-target="#conjointModal"
                                        data-bs-toggle="modal" data-bs-dismiss="modal">Voir Conjoint(es)
                                        affilié(es)</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="btn btn-primary" data-bs-target="#childModal" data-bs-toggle="modal"
                                        data-bs-dismiss="modal">Voir Enfant(s) affilié(s)</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="btn btn-primary" data-bs-target="#parentModal" data-bs-toggle="modal"
                                        data-bs-dismiss="modal">Voir Parents(s) affilié(s)</button>
                                </div>
                            </div>
                        </div>
                    </div>
