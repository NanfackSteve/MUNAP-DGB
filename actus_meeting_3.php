            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 feature-text py-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 ps-lg-0">
                        <div class="section-title text-start">
                            <h2 class="display-6 mb-4"><?= $lang['news']['meeting']['-3-title'] ?></h2>
                        </div>
                        <p class="text-justify mb-4 "><?= $lang['news']['meeting']['-3-text'] ?></p>
                ...
                <div class="col-lg-6 pe-lg-0 wow fadeInUp" data-wow-delay="1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        ...
                        <img class="position-absolute img-fluid img-fluid h-100" src="img/actus/meeting/04-01-2024/1.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
            </div>
        </div>
