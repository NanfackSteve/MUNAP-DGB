    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <a class="btn btn-link" href="actus_events.php"><?= $lang['footer']['section-2-link-4'] ?></a>
                <a class="btn btn-link" href="actus_activities.php"><?= $lang['footer']['section-2-link-5'] ?></a>
            </div>
