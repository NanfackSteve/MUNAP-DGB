        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                ...
                <div class="d-flex pt-2">
                    ...
                    <a class="btn btn-outline-light btn-social" href="https://www.youtube.com/@IT-Support-DGB"><i
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <a class="btn btn-link" href="team_historic.php"><?= $lang['footer']['section-2-link-1'] ?></a>
                <a class="btn btn-link" href="team.php"><?= $lang['footer']['section-2-link-2'] ?></a>
                <a class="btn btn-link" href="prestation_allocations.php"><?= $lang['footer']['section-2-link-3'] ?></a>
                <a class="btn btn-link" href="actus_ca.php"><?= $lang['footer']['section-2-link-4'] ?></a>
                <a class="btn btn-link" href="actus_others.php"><?= $lang['footer']['section-2-link-5'] ?></a>
            </div>
