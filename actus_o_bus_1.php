                    ...
                    <div class="col-lg-6 feature-text py-4 wow fadeIn" data-wow-delay="0.5s">
                        <div class="p-lg-5 ps-lg-0">
                            <div class="section-title text-start">
                                <h2 class="display-5 mb-4"><?= $lang['news']['others']['-2-title'] ?></h2>
                            </div>
                            <p class="text-justify mb-4 pb-2"><?= $lang['news']['others']['-2-text'] ?></p>
                        ...
                        <div id="carouselExampleFade" class="carousel slide " data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="img/actus/activities/actus_bus_A_1.jpg"
                                        class="d-block mx-auto img-fluid  " alt="..." style="height: 20rem;;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_bus_A_2.jpg" class="d-block mx-auto img-fluid "
                                        alt="..." style="height: 20rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_bus_A_3.jpg" class="d-block mx-auto img-fluid "
                                        alt="..." style="height: 20rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_bus_A_4.jpg" class="d-block mx-auto img-fluid "
                                        alt="..." style="height: 20rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_bus_A_5.jpg" class="d-block mx-auto img-fluid "
                                        alt="..." style="height: 20rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_bus_A_6.jpg" class="d-block mx-auto img-fluid "
                                        alt="..." style="height: 20rem;">
                                </div>
                            </div>
