                        ...
                        <div id="carouselExampleFade" class="carousel slide " data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="img/actus/activities/actus_meeting_A_1.jpg" class="d-block w-100 "
                                        alt="..." style="height: 15rem;;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_A_2.jpg" class="d-block w-100"
                                        alt="..." style="height: 15rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_A_3.jpg" class="d-block w-100"
                                        alt="..." style="height: 15rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_A_4.jpg" class="d-block w-100"
                                        alt="..." style="height: 15rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_A_5.jpg" class="d-block w-100"
                                        alt="..." style="height: 15rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_A_6.jpg" class="d-block w-100 "
                                        alt="..." style="height: 15rem;;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_A_7.jpg" class="d-block w-100"
                                        alt="..." style="height: 15rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_A_8.jpg" class="d-block w-100"
                                        alt="..." style="height: 15rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_A_9.jpg" class="d-block w-100"
                                        alt="..." style="height: 15rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_A_10.jpg" class="d-block w-100"
                                        alt="..." style="height: 15rem;">
                                </div>
                            </div>
