...
<html lang="fr">
    ...
    <body>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="btn-pwd" class="btn btn-primary"
                            onclick="changePwd('<?= $_SESSION['token'] ?>')"><?= $lang['Profile']['btn-pwd'] ?></button>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <ul class="col mt-2 mb-2" style="list-style-type: none; padding-left: 0.5rem; ">
                                        ...
                                        <li id="hospital"
                                            ...
                                            <span id="alloc-hospital"
                                                class="badge rounded-pill bg-primary "><?= $nbr_allocation_medicaux ?></span>
                                            <a href="#" class="btn btn-primary btn-sm bo" data-bs-toggle="modal"
        ...
        <script src="/Bootstrap_5/js/profile.js">
        </script>
