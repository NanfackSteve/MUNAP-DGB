...
<div class="container">
    ...
    <div class="section-title">
        ...
        <div class=" d-grid gap-2 col-6 mx-auto m-4">
            <a href="index.php?menu=munap&sub=team_CA" class="btn btn-primary"><?= $lang['team']['organes']['btn-ca'] ?></a>
            <a href="index.php?menu=munap&sub=team_BE" class="btn btn-primary"><?= $lang['team']['organes']['btn-be'] ?></a>
            <a href="index.php?menu=munap&sub=team_CF" class="btn btn-primary"><?= $lang['team']['organes']['btn-cf'] ?></a>
            <a href="index.php?menu=munap&sub=team_DR" class="btn btn-primary"><?= $lang['team']['organes']['btn-dr'] ?></a>
        </div>
