<?php $title_page = $lang['status']['page-title']; ?>
        ...
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a class="text-white underline-hover"
                        href="#title-1"><?= $lang['status']['head-title-1'] ?></a>
                </li>
                <li class="breadcrumb-item"><a class="text-white underline-hover"
                        href="#title-2"><?= $lang['status']['head-title-2'] ?></a>
                </li>
                <li class="breadcrumb-item"><a class="text-white underline-hover"
                        href="#title-3"><?= $lang['status']['head-title-3'] ?></a>
                </li>
                <li class="breadcrumb-item"><a class="text-white underline-hover"
                        href="#title-4"><?= $lang['status']['head-title-4'] ?></a>
                </li>
            </ol>
        </nav>
    </div>
...
<div class="container">
    <div class="row my-3 justify-content-center">
        ...
        <div class="col-md-6 col-lg-10 align-self-center">
            <?php include_once("src/views/templates/docu/statutes_summary.php"); ?>
        </div>
        <div class="col-lg-1"></div>
    </div>
</div>
