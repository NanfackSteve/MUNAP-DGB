        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <a class="btn btn-link"
                    href="index.php?menu=munap&sub=historic"><?= $lang['footer']['section-2-link-1'] ?></a>
                <a class="btn btn-link"
                    href="index.php?menu=munap&sub=organes"><?= $lang['footer']['section-2-link-2'] ?></a>
                <a class="btn btn-link"
                    href="index.php?menu=services&sub=benefits"><?= $lang['footer']['section-2-link-3'] ?></a>
                <a class="btn btn-link"
                    href="index.php?menu=activities&sub=CA"><?= $lang['footer']['section-2-link-4'] ?></a>
                <a class="btn btn-link"
                    href="index.php?menu=activities&sub=others"><?= $lang['footer']['section-2-link-5'] ?></a>
            </div>
            <!-- Useful Links End -->
