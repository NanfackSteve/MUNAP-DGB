                            ...
                            <div class="p-2 p-lg-3 wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                <ul class="mb-4 py-0 fleche-puce">
                                    <li><a href="#" class="btn btn-link p-0" data-bs-toggle="modal"
                                            data-bs-target="#adhesionModal"><?= $lang['team']['who']['entry-cost-link'] ?></a>
                                    </li>
                                    <li><a href="#" class="btn btn-link p-0" data-bs-toggle="modal"
                                            data-bs-target="#cotisationModal"><?= $lang['team']['who']['cotisation-link'] ?></a>
                                    </li>
                                </ul>
                                </p>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal"><?= $lang['team']['who']['modal-close'] ?></button>
                                                <button class="btn btn-primary" data-bs-target="#cotisationModal"
                                                    data-bs-toggle="modal"
                                                    data-bs-dismiss="modal"><?= $lang['team']['who']['modal-see-dues'] ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button class="btn btn-primary" data-bs-target="#adhesionModal"
                                                    data-bs-toggle="modal"
                                                    data-bs-dismiss="modal"><?= $lang['team']['who']['modal-see-fees'] ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
