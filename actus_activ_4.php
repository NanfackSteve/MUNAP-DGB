                ...
                <div class="row g-0 mx-lg-0">
                    <div class="col-lg-6 feature-text py-4 wow fadeIn" data-wow-delay="0.5s">
                        <div class="p-lg-5 ps-lg-0">
                            <div class="section-title text-start">
                                <h2 class="display-5 mb-4">25 ième Session Ordinaire du Conseil d'Administration</h2>
                            </div>
                    ...
                    <div class="col-lg-6 pe-lg-0 wow fadeInUp" data-wow-delay="1s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <iframe src="https://www.youtube.com/embed/o8G9kXN2F9g" frameborder="1" allowfullscreen
                                class="d-block mx-auto " height="100%" width="100%"></iframe>

                            <!-- <img class="position-absolute img-fluid img-fluid h-100"
                                src="img/actus/activities/actus_meeting_B_2.jpg" style="object-fit: cover;" alt=""> -->
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div id="carouselExampleFade" class="carousel slide " data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="img/actus/activities/actus_meeting_B_1.jpg"
                                        class="d-block mx-auto img-fluid " alt="..." style="height: 20rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_B_2.jpg"
                                        class="d-block mx-auto img-fluid" alt="..." style="height: 20rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_B_3.jpg"
                                        class="d-block mx-auto img-fluid" alt="..." style="height: 20rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_B_4.jpg"
                                        class="d-block mx-auto img-fluid" alt="..." style="height: 20rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_B_5.jpg"
                                        class="d-block mx-auto img-fluid" alt="..." style="height: 20rem;">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/actus/activities/actus_meeting_B_6.jpg"
                                        class="d-block mx-auto img-fluid " alt="..." style="height: 20rem;;">
                                </div>
                            </div>
