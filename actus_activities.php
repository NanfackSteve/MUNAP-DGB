                ...
                <div class="row g-4 portfolio-container">
                                ...
                                <div class="portfolio-overlay">
                                    <a class="btn btn-square btn-outline-light mx-1"
                                        href="img/actus/activities/actus_sport_A_0.jpg" data-lightbox="portfolio"><i
                                            class="fa fa-eye"></i></a>
                                    <a class="btn btn-square btn-outline-light mx-1" href="actus_activ_6.php"><i
                                ...
                                <div class="portfolio-overlay">
                                    <a class="btn btn-square btn-outline-light mx-1"
                                        href="img/actus/activities/actus_bus_B_0.jpg" data-lightbox="portfolio"><i
                                            class="fa fa-eye"></i></a>
                                    <a class="btn btn-square btn-outline-light mx-1" href="actus_activ_5.php"><i
                                            class="fa fa-link"></i></a>
                                </div>
                            </div>
                            <div class="border border-5 border-light border-top-0 p-4">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item second wow fadeIn" data-wow-delay="0.1s">
                        <div class="rounded overflow-hidden">
                            ...
                            <div class="border border-5 border-light border-top-0 p-4">
                                <p class="text-primary fw-medium mb-2">
                                    <?= $lang['news']['activity']['-3-place'] ?></p>
                                <h5 class="lh-base mb-0"><?= $lang['news']['activity']['-3-title'] ?> </a>
                            </div>
                        </div>
                    </div>
