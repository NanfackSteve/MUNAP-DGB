    ...
    <body>
        ...
        <div class="container-fluid page-header-news py-5 mb-5">
            <div class="container py-5">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Activités de la Mutuelle</h1>
            </div>
        </div>
        <!-- Page Header End -->
                ...
                <div class="row mt-n2 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="col-12 text-center">
                        <ul class="list-inline mb-5" id="portfolio-flters">
                            ...
                            <li class="mx-2" data-filter=".first">Meetings</li>
                            <li class="mx-2" data-filter=".second">Retraites</li>
                            <li class="mx-2" data-filter=".third">Materiels</li>
                        </ul>
                    </div>
                </div>
